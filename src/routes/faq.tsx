...
const SECTIONS: { title: string; items: FaqItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "TCR·TSR은 무엇인가요?",
        a: "TCR은 중국횡단철도, TSR은 시베리아횡단철도로, 아시아와 러시아·중앙아시아·유럽을 잇는 대표 대륙횡단 철도 회랑입니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "기후 리스크는 어떻게 감지하나요?",
        a: "Logisight가 개발한 AI 기상 예보를 기반으로 전 세계 항만·해협·내륙 철도 거점의 기상 리스크를 모니터링합니다. 확정이 아닌 예측·가능성으로 제공됩니다.",
      },
    ],
  },
  {
