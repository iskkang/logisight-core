...
export const Route = createFileRoute("/rail-map")({
  ...
  head: () => ({
    meta: [
      { title: "Rail Risk Map - Logisight" },
      {
        name: "description",
        content: "North American intermodal rail corridor status map.",
      },
    ],
  }),
  component: RailMapPage,
});
...
function RailMapPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f3f6fa] text-[#1a2433]">
      <div className="grid min-h-screen grid-cols-[320px_minmax(0,1fr)] grid-rows-[minmax(0,1fr)_auto] max-[900px]:grid-cols-1 max-[900px]:grid-rows-[auto_70vh_auto]">
